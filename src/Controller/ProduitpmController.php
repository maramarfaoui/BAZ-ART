...
';
     ...
     */
    public function editg(Request $request, Produitpm $produitpm, EntityManagerInterface $entityManager): Response
    {
...
*/
    ...
    /**
     * @Route("/produitpm/{id}", name="app_produitpm_show", methods={"GET"})
     */
    public function show(Produitpm $commandpm): Response
    {
        return $this->render('produitpm/show.html.twig', [
            'produitpm' => $commandpm,
        ]);
    }
