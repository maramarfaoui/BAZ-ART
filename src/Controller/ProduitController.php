...
{
    #[Route('/indexOeuvre', name: 'display_produit', methods: ['GET'])]
    ...
    #[Route('/boutique/{page?1}/{nbre?3}', name: 'display_produit.pagination')]
...
//    }
    ...
    #[Route('/delete/removeproduit/{id}"', name: 'supp_prod_maram', methods: ['POST'],requirements: ['id' => '\d+'])]
    ...
    public function updateRating($idprod){
